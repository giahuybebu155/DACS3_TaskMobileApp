    ...
    fun reconnectWebSocket() {
        viewModelScope.launch {
            try {
                ...
                val authToken = com.example.taskapplication.data.util.DataStoreManager.getInstance(androidx.work.impl.utils.WorkManagerImpl.getInstance().applicationContext).getAuthToken()
                val currentTeamId = com.example.taskapplication.data.util.DataStoreManager.getInstance(androidx.work.impl.utils.WorkManagerImpl.getInstance().applicationContext).getCurrentTeamId()
