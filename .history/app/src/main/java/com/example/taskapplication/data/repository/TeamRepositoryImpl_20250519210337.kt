...
class TeamRepositoryImpl @Inject constructor(
    ...
    override suspend fun inviteUserToTeam(teamId: String, userEmail: String): Result<com.example.taskapplication.domain.model.TeamMember> {
        try {
            ...
            com.example.taskapplication.data.database.AppDatabase.getInstance(androidx.work.impl.utils.WorkManagerImpl.getInstance().applicationContext)
                .teamInvitationDao()
                .insertInvitation(invitationEntity)
