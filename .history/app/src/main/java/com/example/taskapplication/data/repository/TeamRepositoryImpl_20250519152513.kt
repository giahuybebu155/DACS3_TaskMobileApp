...
class TeamRepositoryImpl @Inject constructor(
    ...
    private fun TeamEntity.toApiModel(): com.example.taskapplication.data.api.model.TeamDto {
        return com.example.taskapplication.data.api.model.TeamDto(
            id = this.id,
            name = this.name,
            description = this.description ?: "",
            ownerId = this.ownerId,
            createdBy = this.createdBy ?: this.ownerId,
    ...
    private fun TeamMemberEntity.toApiModel(): com.example.taskapplication.data.api.model.TeamMemberDto {
        return com.example.taskapplication.data.api.model.TeamMemberDto(
            id = this.id,
            teamId = this.teamId,
            userId = this.userId,
            role = this.role,
