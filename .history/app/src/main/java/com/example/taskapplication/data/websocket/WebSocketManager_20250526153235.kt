...
class WebSocketManager @Inject constructor(
    ...
    fun connect(authToken: String, teamId: String) {
        ...
        // TEMPORARY DISABLE: Skip WebSocket connection for testing
        Log.w(TAG, "⚠️ [CONNECT] TEMPORARY DISABLE: WebSocket connection disabled for testing")
        Log.w(TAG, "⚠️ [CONNECT] Setting connection state to CONNECTED without actual connection")
