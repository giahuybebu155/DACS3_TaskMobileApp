...
import com.example.taskapplication.data.model.NotificationSettings
...
class DataStoreManager @Inject constructor(
    ...
    suspend fun saveNotificationSettings(
        ...
        context.dataStore.edit { preferences ->
            ...
            preferences[PreferencesKeys.TASK_REMINDERS] = taskReminders
            preferences[PreferencesKeys.TEAM_INVITATIONS] = teamInvitations
            preferences[PreferencesKeys.TEAM_UPDATES] = teamUpdates
            preferences[PreferencesKeys.CHAT_MESSAGES] = chatMessages
        }
    }
    ...
    val notificationSettings: Flow<NotificationSettings> = context.dataStore.data.map { preferences ->
        NotificationSettings(
            ...
            teamUpdates = preferences[PreferencesKeys.TEAM_UPDATES] ?: true,
            chatMessages = preferences[PreferencesKeys.CHAT_MESSAGES] ?: true
        )
    }
}