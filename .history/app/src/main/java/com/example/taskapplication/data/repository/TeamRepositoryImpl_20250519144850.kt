...
class TeamRepositoryImpl @Inject constructor(
    ...
    private suspend fun syncRoleHistory(): Result<Unit> {
        try {
            ...
            // Đẩy lên server
            val response = apiService.syncRoleHistory(pendingRoleHistory.map { it.toApiModel() })
