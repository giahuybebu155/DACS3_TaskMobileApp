...
interface ApiService {
    ...
    @POST("teams/tasks")
    suspend fun createTeamTask(@Body task: com.example.taskapplication.data.api.model.TeamTaskDto): Response<com.example.taskapplication.data.api.response.TeamTaskResponse>

    @PUT("teams/tasks/{taskId}")
    suspend fun updateTeamTask(@Path("taskId") taskId: String, @Body task: com.example.taskapplication.data.api.model.TeamTaskDto): Response<com.example.taskapplication.data.api.response.TeamTaskResponse>

    @DELETE("teams/tasks/{taskId}")
    suspend fun deleteTeamTaskById(@Path("taskId") taskId: String): Response<Unit>

    @POST("teams/{teamId}/members")
    suspend fun inviteUserToTeam(
        @Path("teamId") teamId: String,
        @Body request: com.example.taskapplication.data.api.request.TeamMemberRequest
    ...
    @GET("invitations")
    suspend fun getUserInvitations(): Response<List<TeamInvitationResponse>>  // Fix: Server trả về array, không phải object

    @GET("teams")
    suspend fun getUserTeams(): Response<List<TeamResponse>>
    ...
    suspend fun sendInvitationByUuid(
        @Path("team_uuid") teamUuid: String,
        @Body request: TeamInvitationRequest
    ): Response<TeamInvitationResponse>
    ...
    suspend fun acceptInvitation(@Body request: Map<String, String>): Response<AcceptInvitationResponse>

    @POST("invitations/reject")
    suspend fun rejectInvitation(@Body request: Map<String, String>): Response<RejectInvitationResponse>
