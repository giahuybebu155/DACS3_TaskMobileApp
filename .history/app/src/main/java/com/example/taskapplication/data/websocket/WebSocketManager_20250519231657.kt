        ...
        try {
            ...
            when (eventName) {
                ...
                "team.invitation.created", "team-invitation", "team_invitation" -> {
                    ...
                    Log.d(TAG, "Parsed invitation data: teamId=$teamId, inviterId=$inviterId, invitationId=$invitationId")
                    ...
                    Log.d(TAG, "Enqueued invitation sync work after receiving invitation event")
                }
