...
class WebSocketManager @Inject constructor(
    ...
    fun connect(authToken: String) {
        ...
        // 🔧 DEBUG: Test with echo server first
        val wsUrl = "ws://echo.websocket.org"
        // val wsUrl = "ws://10.0.2.2:8080/ws?token=$authToken" // Use this for Laravel Reverb
        Log.d(TAG, "🔍 [CONNECT] Laravel Reverb WebSocket URL: $wsUrl")
    ...
    fun connect(authToken: String, teamId: String) {
        ...
        val wsUrl = "ws://10.0.2.2:8080/ws?token=$authToken"
        Log.d(TAG, "🌐 [CONNECT] WebSocket URL: $wsUrl")
