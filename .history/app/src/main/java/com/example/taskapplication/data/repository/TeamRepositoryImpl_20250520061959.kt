...
class TeamRepositoryImpl @Inject constructor(
    ...
    override suspend fun inviteUserToTeam(teamId: String, userEmail: String): Result<com.example.taskapplication.domain.model.TeamMember> {
        try {
            ...
            Log.d(TAG, "🔍 [THEO DÕI] Kiểm tra người tạo nhóm: isTeamCreator=$isTeamCreator, ownerId=${team.ownerId}, currentUserId=$currentUserId")
            ...
            val isManager = teamMember?.role == "manager"

            Log.d(TAG, "🔍 [THEO DÕI] Kiểm tra thành viên nhóm: teamMember=${teamMember?.id}, role=${teamMember?.role}")
            Log.d(TAG, "🔍 [THEO DÕI] Kiểm tra quyền: isManager=$isManager, isTeamCreator=$isTeamCreator")
