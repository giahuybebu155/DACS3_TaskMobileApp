...
class CompositeWorkerFactory @Inject constructor(
    ...
    override fun createWorker(
        ...
        // Thử tạo worker từ TeamSyncWorkerFactory
        val teamSyncWorker = teamSyncWorkerFactory.createWorker(appContext, workerClassName, workerParameters)
        if (teamSyncWorker != null) {
